			...
			<aui:fieldset>
				...
				<div class="row">
					<div class="col-md-3">
						...
						<aui:input disabled="<%= !configurationEntryEditable %>" label="max-width-px" min="1" name="maxWidth" type="tel" value="<%= maxWidth %>">
					...
					<div class="col-md-3">
						...
						<aui:input disabled="<%= !configurationEntryEditable %>" label="max-height-px" min="1" name="maxHeight" type="tel" value="<%= maxHeight %>">
							<aui:validator name="number" />
						</aui:input>
					</div>
				</div>
